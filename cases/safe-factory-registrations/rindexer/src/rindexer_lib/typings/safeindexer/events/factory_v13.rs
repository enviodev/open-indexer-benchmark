...
use super::factory_v13_abi_gen::RindexerFactoryV13Gen::{
    self, RindexerFactoryV13GenEvents, RindexerFactoryV13GenInstance,
};
...
pub type ProxyCreationData = RindexerFactoryV13Gen::ProxyCreation;
...
pub enum FactoryV13EventType<TExtensions>
where
...
impl<TExtensions> FactoryV13EventType<TExtensions>
where
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            FactoryV13EventType::ProxyCreation(_) => {
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            FactoryV13EventType::ProxyCreation(_) => "ProxyCreation",
        }
    }

    pub fn contract_name(&self) -> String {
        "FactoryV13".to_string()
    }
    ...
    pub async fn register(self, manifest_path: &PathBuf, registry: &mut EventCallbackRegistry) {
        ...
        let (callback, reorg_sender): (
            ...
            FactoryV13EventType::ProxyCreation(event) => {

...
use super::factory_v14_common_proxy_creation_proxy_abi_gen::{
    RindexerFactoryV14CommonProxyCreationProxyGen::{self, RindexerFactoryV14CommonProxyCreationProxyGenInstance, RindexerFactoryV14CommonProxyCreationProxyGenEvents}
};
...
pub type ProxyCreationData = RindexerFactoryV14CommonProxyCreationProxyGen::ProxyCreation;
...
pub enum FactoryV14CommonProxyCreationProxyEventType<TExtensions>
where
...
impl<TExtensions> FactoryV14CommonProxyCreationProxyEventType<TExtensions>
where
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            FactoryV14CommonProxyCreationProxyEventType::ProxyCreation(_) => {
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            FactoryV14CommonProxyCreationProxyEventType::ProxyCreation(_) => "ProxyCreation",
        }
    }

    pub fn contract_name(&self) -> String {
        "FactoryV14CommonProxyCreationProxy".to_string()
    }
    ...
    pub async fn register(self, manifest_path: &PathBuf, registry: &mut EventCallbackRegistry) {
        ...
        let (callback, reorg_sender): (
            ...
            FactoryV14CommonProxyCreationProxyEventType::ProxyCreation(event) => {

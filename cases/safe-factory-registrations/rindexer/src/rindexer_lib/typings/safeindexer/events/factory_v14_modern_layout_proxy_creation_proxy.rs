...
use super::factory_v14_modern_layout_proxy_creation_proxy_abi_gen::{
    RindexerFactoryV14ModernLayoutProxyCreationProxyGen::{self, RindexerFactoryV14ModernLayoutProxyCreationProxyGenInstance, RindexerFactoryV14ModernLayoutProxyCreationProxyGenEvents}
};
...
pub type ProxyCreationData = RindexerFactoryV14ModernLayoutProxyCreationProxyGen::ProxyCreation;
...
pub enum FactoryV14ModernLayoutProxyCreationProxyEventType<TExtensions>
where
...
impl<TExtensions> FactoryV14ModernLayoutProxyCreationProxyEventType<TExtensions>
where
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            FactoryV14ModernLayoutProxyCreationProxyEventType::ProxyCreation(_) => {
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            FactoryV14ModernLayoutProxyCreationProxyEventType::ProxyCreation(_) => "ProxyCreation",
        }
    }

    pub fn contract_name(&self) -> String {
        "FactoryV14ModernLayoutProxyCreationProxy".to_string()
    }
    ...
    pub async fn register(self, manifest_path: &PathBuf, registry: &mut EventCallbackRegistry) {
        ...
        let (callback, reorg_sender): (
            ...
            FactoryV14ModernLayoutProxyCreationProxyEventType::ProxyCreation(event) => {

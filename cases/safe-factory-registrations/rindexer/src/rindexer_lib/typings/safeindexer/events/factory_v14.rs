...
use super::factory_v14_abi_gen::RindexerFactoryV14Gen::{
    self, RindexerFactoryV14GenEvents, RindexerFactoryV14GenInstance,
};
...
pub type ProxyCreationData = RindexerFactoryV14Gen::ProxyCreation;
...
pub enum FactoryV14EventType<TExtensions>
where
...
impl<TExtensions> FactoryV14EventType<TExtensions>
where
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            FactoryV14EventType::ProxyCreation(_) => {
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            FactoryV14EventType::ProxyCreation(_) => "ProxyCreation",
        }
    }

    pub fn contract_name(&self) -> String {
        "FactoryV14".to_string()
    }
    ...
    pub async fn register(self, manifest_path: &PathBuf, registry: &mut EventCallbackRegistry) {
        ...
        let (callback, reorg_sender): (
            ...
            FactoryV14EventType::ProxyCreation(event) => {

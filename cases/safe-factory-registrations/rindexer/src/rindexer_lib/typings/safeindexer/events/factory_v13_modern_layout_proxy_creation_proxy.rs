...
use super::factory_v13_modern_layout_proxy_creation_proxy_abi_gen::{
    RindexerFactoryV13ModernLayoutProxyCreationProxyGen::{self, RindexerFactoryV13ModernLayoutProxyCreationProxyGenInstance, RindexerFactoryV13ModernLayoutProxyCreationProxyGenEvents}
};
...
pub type ProxyCreationData = RindexerFactoryV13ModernLayoutProxyCreationProxyGen::ProxyCreation;
...
pub enum FactoryV13ModernLayoutProxyCreationProxyEventType<TExtensions>
where
...
impl<TExtensions> FactoryV13ModernLayoutProxyCreationProxyEventType<TExtensions>
where
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            FactoryV13ModernLayoutProxyCreationProxyEventType::ProxyCreation(_) => {
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            FactoryV13ModernLayoutProxyCreationProxyEventType::ProxyCreation(_) => "ProxyCreation",
        }
    }

    pub fn contract_name(&self) -> String {
        "FactoryV13ModernLayoutProxyCreationProxy".to_string()
    }
    ...
    pub async fn register(self, manifest_path: &PathBuf, registry: &mut EventCallbackRegistry) {
        ...
        let (callback, reorg_sender): (
            ...
            FactoryV13ModernLayoutProxyCreationProxyEventType::ProxyCreation(event) => {

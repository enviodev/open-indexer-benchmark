...
use super::factory_v13_legacy_layout_proxy_creation_proxy_abi_gen::{
    RindexerFactoryV13LegacyLayoutProxyCreationProxyGen::{self, RindexerFactoryV13LegacyLayoutProxyCreationProxyGenInstance, RindexerFactoryV13LegacyLayoutProxyCreationProxyGenEvents}
};
...
pub type ProxyCreationData = RindexerFactoryV13LegacyLayoutProxyCreationProxyGen::ProxyCreation;
...
pub enum FactoryV13LegacyLayoutProxyCreationProxyEventType<TExtensions>
where
...
impl<TExtensions> FactoryV13LegacyLayoutProxyCreationProxyEventType<TExtensions>
where
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            FactoryV13LegacyLayoutProxyCreationProxyEventType::ProxyCreation(_) => {
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            FactoryV13LegacyLayoutProxyCreationProxyEventType::ProxyCreation(_) => "ProxyCreation",
        }
    }

    pub fn contract_name(&self) -> String {
        "FactoryV13LegacyLayoutProxyCreationProxy".to_string()
    }
    ...
    pub async fn register(self, manifest_path: &PathBuf, registry: &mut EventCallbackRegistry) {
        ...
        let (callback, reorg_sender): (
            ...
            FactoryV13LegacyLayoutProxyCreationProxyEventType::ProxyCreation(event) => {

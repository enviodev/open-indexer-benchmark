...
const util_internal_json_fix_unsafe_integers_1 = require("@subsquid/util-internal-json-fix-unsafe-integers");
...
class WsConnection {
    ...
    connect() {
        return new Promise((resolve, reject) => {
            ...
            let ws = this._ws = new websocket_1.w3cwebsocket(this.url, undefined, undefined, this.headers, undefined, {
                // default: true
    ...
    onMessage(data) {
        ...
        try {
            if (this.fixUnsafeIntegers) {
                data = (0, util_internal_json_fix_unsafe_integers_1.fixUnsafeIntegers)(data);
            }
            msg = JSON.parse(data);
        }
        catch (e) {
...
function isNotification(res) {
    return typeof res.method == 'string';
}

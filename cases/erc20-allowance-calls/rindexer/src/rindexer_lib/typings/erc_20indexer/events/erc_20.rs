...
pub type ApprovalData = RindexerERC20Gen::Approval;
    ...
    TExtensions: 'static + Send + Sync,
{
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            ERC20EventType::Approval(_) => "Approval",
        }
    }
    ...
    fn decoder(
        ...
        match self {
            ERC20EventType::Approval(_) => Arc::new(move |topics: Vec<B256>, data: Bytes| {
